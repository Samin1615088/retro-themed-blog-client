    ...
    return (
        <div className="flex flex-col w-full h-screen p-5 xl:w-1/2 xl:mx-auto">
            ...
            <form className="flex flex-col pt-16 lg:w-1/2 lg:mx-auto">
                ...
                <input className="w-full py-2 text-lg border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password..." />
                <button className="w-full p-4 mt-5 font-semibold tracking-wide text-gray-100 bg-indigo-500 rounded-full shadow-lg font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600">Login</button>
            </form>
