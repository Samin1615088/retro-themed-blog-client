...
const Header = () => {
    return (
        <header className="relative">
            ...
            <img className="object-cover w-full h-32 " src="https://image.freepik.com/free-vector/classic-retro-80s-style-tropical-sunset-with-palm-tree_1017-31136.jpg" alt="background image" />
        </header>
    );
};
